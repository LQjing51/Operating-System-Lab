...
{
    // TODO:
    return pa2kva(get_pa(((PTE*)pgdir_va)[va]));
}
...
{
    // TODO:
    *entry &= (1lu << _PAGE_PFN_SHIFT) - 1; //clear the higher bits,remain the low 10bits
    *entry |=  pfn << _PAGE_PFN_SHIFT;  //fill in the alloced page address
}
